...
def check(text):
    ...
    # TODO: hanspell 동작하지 않으면 passportKey와 callback 수정할 것
    payload = {
        'color_blindness': '0',
        'q': text,
        'passportKey': '0302d2240c6eafd7b555f42ceaab43083ad92697',
        '_callback': 'jQuery112403284887802373959_1713442564792',
    }
